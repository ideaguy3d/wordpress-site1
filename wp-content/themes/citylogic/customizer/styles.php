...
function citylogic_customizer_library_build_styles() {
	global $mobile_menu_breakpoint, $solidify_breakpoint, $mobile_menu_button_color, $mobile_menu_color;
	
	// Activate the mobile menu when on a mobile device
	if ( get_theme_mod( 'citylogic-mobile-menu', customizer_library_get_default( 'citylogic-mobile-menu' ) ) ) {
		if ( wp_is_mobile() && get_theme_mod( 'citylogic-mobile-menu-activate-on-mobile', customizer_library_get_default( 'citylogic-mobile-menu-activate-on-mobile' ) ) ) {
			$mobile_menu_breakpoint = 10000000;
			$solidify_breakpoint = 10000000;
		} else {
			$mobile_menu_breakpoint = floatVal( get_theme_mod( 'citylogic-mobile-menu-breakpoint', customizer_library_get_default( 'citylogic-mobile-menu-breakpoint' ) ) );
			
			if ( $mobile_menu_breakpoint > $solidify_breakpoint ) {
				$solidify_breakpoint = floatVal( get_theme_mod( 'citylogic-mobile-menu-breakpoint', customizer_library_get_default( 'citylogic-mobile-menu-breakpoint' ) ) );
			}
		}
	}
