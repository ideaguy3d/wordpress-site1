	    ...
	    <div class="site-header-right <?php echo $top_right == '' ? 'top-empty' : ''; ?>">
	        ...
	        <div class="bottom navigation-menu">
	        	...
	        	<div class="main-navigation-container">
					...
					<nav id="site-navigation" class="main-navigation rollover-underline centered-submenu <?php echo esc_attr( get_theme_mod( 'citylogic-navigation-menu-alignment', customizer_library_get_default( 'citylogic-navigation-menu-alignment' ) ) ); ?>" role="navigation">
