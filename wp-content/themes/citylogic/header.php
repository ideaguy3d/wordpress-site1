...
<?php
global $slider_shortcode, $show_slider, $slider_type;
$show_slider = false;
...
if ( is_front_page() && !$show_header_video && get_header_image() && get_theme_mod( 'citylogic-slider-type', customizer_library_get_default( 'citylogic-slider-type' ) ) == 'citylogic-no-slider' ) {
	$show_header_image = true;
}

$logo_container_opacity = get_theme_mod( 'citylogic-layout-logo-container-opacity', customizer_library_get_default( 'citylogic-layout-logo-container-opacity' ) );

global $is_logo_container_transparent;

$is_logo_container_transparent = true;
...
<header id="masthead" class="site-header left-aligned <?php echo $show_slider || $show_header_image || $show_header_video ? 'forced-solid' : ''; ?> <?php echo implode( ' ', $header_classes ); ?>" role="banner">
...
// if ( is_front_page() && get_theme_mod( 'citylogic-slider-type', 'citylogic-no-slider' ) != 'citylogic-no-slider' ) :
// 	get_template_part( 'library/template-parts/slider' );
...
<div class="content-container <?php echo $show_slider || $show_header_image || $show_header_video ? 'extra-padded' : ''; ?>">
